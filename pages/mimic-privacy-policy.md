...
I want to inform you that whenever you use my Service, in the case of an error in the app I collect basic error and usage logs directly, without the use of any third-party logging services. This Log Data may include information such as your device Internet Protocol ("IP") address, device name, operating system version, the configuration of the app when utilizing my Service, the time and date of your use of the Service, and other statistics. I use Apple's native OSLog framework, leveraging its built-in security and privacy features, to log information useful for debugging. Where applicable, sensitive data such as file paths are redacted by OSLog before being logged.

Service Providers

I do not employ any third-party companies or services to log errors or analyze usage of the Service.

For versions of Mimic distributed outside the App Store (direct download), the app uses [Sparkle](https://sparkle-project.org/), a third-party open-source framework, to check for and deliver software updates. This may involve your device contacting Sparkle's update-check endpoint to determine if a new version is available. Sparkle does not collect personal information as part of this process.
...
This policy is effective as of **August 3rd 2026**
